...
LOAD DATA LOCAL INFILE 'C:\\Users\\SBS\\Downloads\\주소\\지번.txt' INTO TABLE jibun_info_m CHARACTER SET euckr FIELDS TERMINATED BY '|' IGNORE 1 LINES;

'C:\\Users\\SBS\\Downloads\\주소\\지번.txt' -> 파일이 있는 경로
